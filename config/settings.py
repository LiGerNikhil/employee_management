...
# https://docs.djangoproject.com/en/5.0/topics/auth/default/#authentication-views

LOGIN_URL = '/login/'
LOGIN_REDIRECT_URL = None  # We're handling redirects in the login view
...
THEME_VARIABLES = {
    "template_name": "Employee Management",
    "template_suffix": "System",
}
...
# Default tolerance for face_recognition.compare_faces (lower is stricter)
